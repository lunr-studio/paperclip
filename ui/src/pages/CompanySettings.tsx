...
Then verify with: curl -fsS <base-url>/api/health`;
  ...
  const resolutionLine = resolutionTestUrl
    ? `\nAsk your board operator to test Paperclip-to-gateway reachability from the Paperclip side using: ${resolutionTestUrl}?url=<urlencoded-gateway-url> (using the hostname that worked above). Do not assume your 172.x is necessarily reachable from Paperclip. `
    : "";
